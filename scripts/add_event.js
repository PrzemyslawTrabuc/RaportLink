$(document).ready(function addEvent() {      
  $("button[name='add_event']").click(function addEvent() {
   ...
   if(time != "" && text !="")
   {
      ...
      var domElement = $('<div class="event"><h3><i class="far fa-clock"></i> '+time+'</h3><br><p>'+text+'<p class="time_stamp">'+date+' <button type="button" name="delete_event" class="btn btn-danger" onclick="return this.parentNode.parentNode.remove();">Usuń</button></p></div>');           
